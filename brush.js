...
d3.chart.brush = function() {
  ...
  function chart(container) {
    ...
    g.selectAll(".background")
      .style({fill: "#f1f1f1", visibility: "visible"})
    g.selectAll(".extent")
    ...
    rects.attr({
      x: function(d) { return scale(d.averageScore);},
      y: 0,
      width: 1,
      height: height
    ...
    brush.on("brushend", function() {
      ...
      var filtered = data.filter(function(d) {
        return (d.averageScore > ext[0] && d.averageScore < ext[1])
      })
      g.selectAll("rect.events")
      .style("stroke", "")
      
      // g.selectAll("rect.events")
      // .data(filtered, function(d) { return d.gender })
      // .style({
      //   stroke: "#fff"
      // })
  ...
  chart.highlight = function(data) {
    ...
    rects.data(data, function(d) { return d.mathScore })
    .style("stroke", "orange")
